...
\begin{cventries}
  ...
  \cventry
{UI Engineer (C++, Lua)} % Job title
{Sledgehammer Games} % Organization
...
%---------------------------------------------------------
  \cventry
    {UI Programmer (C++, Unreal Engine, Node.js)} % Job title
...
%\item Overhauled the UI for the Prestige and Perk system, requiring a deep dive into legacy code and systems.
...
%---------------------------------------------------------
  \cventry
    {UI Programmer Co-op (C++, Unreal Engine, ActionScript)} % Job title
    {} % Organization
    {} % Location
